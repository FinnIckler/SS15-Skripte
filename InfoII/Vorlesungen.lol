\contentsline {lstlisting}{\numberline {1}Arithmetik mit Flie\ss kommazahlen}{5}{lstlisting.1}
\contentsline {lstlisting}{\numberline {2}Schlüsselwort define}{6}{lstlisting.2}
\contentsline {lstlisting}{\numberline {3}Lambda Abstraktion}{6}{lstlisting.3}
\contentsline {lstlisting}{\numberline {4}Bilderzusammenstellung am Beispiel einer Uhr}{8}{lstlisting.4}
\contentsline {lstlisting}{\numberline {5}Die one-of Signatur}{11}{lstlisting.5}
\contentsline {lstlisting}{\numberline {6}Konstruktion eines eigenen Ifs?}{11}{lstlisting.6}
\contentsline {lstlisting}{\numberline {7}Absolutbetrag durch cond}{13}{lstlisting.7}
\contentsline {lstlisting}{\numberline {8}Boolsche Ausdrücke mit and und or}{14}{lstlisting.8}
\contentsline {lstlisting}{\numberline {9}Record Definitionen}{14}{lstlisting.9}
\contentsline {lstlisting}{\numberline {10}Check-property}{16}{lstlisting.10}
\contentsline {lstlisting}{\numberline {11}Übersetzung mathematischer Aussagen in check-property}{16}{lstlisting.11}
\contentsline {lstlisting}{\numberline {12}Konstruktoren und Selektoren}{17}{lstlisting.12}
\contentsline {lstlisting}{\numberline {13}predicate Signaturen am Beispiel von Längen- und Breitengrade}{19}{lstlisting.13}
\contentsline {lstlisting}{\numberline {14}Ersetzung one-of druch predicate Siganturen}{19}{lstlisting.14}
\contentsline {lstlisting}{\numberline {15}Geocoding}{21}{lstlisting.15}
\contentsline {lstlisting}{\numberline {16}cond mit gemischten Daten}{22}{lstlisting.16}
\contentsline {lstlisting}{\numberline {17}Wrapper und Worker}{23}{lstlisting.17}
\contentsline {lstlisting}{\numberline {18}make-pair, ein polymorpher Datentyp}{25}{lstlisting.18}
\contentsline {lstlisting}{\numberline {19}Listen mit Signatur list-of}{27}{lstlisting.19}
\contentsline {lstlisting}{\numberline {20}Geschachtelte Listen}{29}{lstlisting.20}
\contentsline {lstlisting}{\numberline {21}Rekursion auf Listen: Länge einer Liste}{30}{lstlisting.21}
\contentsline {lstlisting}{\numberline {22}Rekursion: Zusammenfügen zweier Listen}{31}{lstlisting.22}
\contentsline {lstlisting}{\numberline {23}Bildmanipulation mit Listen aus Pixeln}{32}{lstlisting.23}
\contentsline {lstlisting}{\numberline {24}Check-property mit Einschränkungen}{35}{lstlisting.24}
\contentsline {lstlisting}{\numberline {25}Rekursion auf natürlichen Zahlen: Fakultät}{35}{lstlisting.25}
