...
\racket{Die one-of Signatur}{one-of am Beispiel des Fu\ss ballpunktesystems}{oneof}
Reduktion von if:\\
...
literate=
{42}{{{\color[rgb]{0.159,0.501,0.133}42}}}2 {0}{{{\color[rgb]{0.159,0.501,0.133}0}}}1,caption={[Konstruktion eines eigenen Ifs?]Koennen wir unser eigenes `if' aus `cond' konstruieren?  (Nein!)}]{myif.rkt}
...
\end{cases}$
\newpage
\racket{Absolutbetrag durch cond}{Absolutwert von x}{Abs}
...
\newpage
\racket{Boolsche Ausdrücke mit and und or}{Konstruktion komplexer Prädikate mittels `and' und `or'}{andor}
