...
\end{center}
\code{(+ 40 2)} und \code{(odd? 42)} sind Beispiele f\"ur \underline{Ausdr\"ucke}, die bei \underline{Auswertung} einen Wert liefern.\\
(Notation: \eval)\\
\code{(+ 40 2)} $\underbrace{\longrightsquigarrow}_{Reduktion}$ 42\\
\code{(odd? 42)} \eval \#f
\bigskip\\
