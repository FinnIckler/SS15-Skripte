...
\end{lstlisting}
\begin{mdframed}
\begin{SCodeFlow}\begin{RktBlk}\begin{SingleColumn}\RktCmt{;}\RktCmt{~}\RktCmt{Achtung{\hbox{\texttt{:}}} Arithmetik mit Fliesskommazahlen (real) unterliegt Rundung{\hbox{\texttt{!}}}}

\RktPn{(}\RktSym{+}\mbox{\hphantom{\Scribtexttt{x}}}\RktVal{0{\hbox{\texttt{.}}}7}

\mbox{\hphantom{\Scribtexttt{xxx}}}\RktPn{(}\RktSym{\mbox{{-}}}\mbox{\hphantom{\Scribtexttt{x}}}\RktPn{(}\RktSym{/}\mbox{\hphantom{\Scribtexttt{x}}}\RktVal{1/2}\mbox{\hphantom{\Scribtexttt{x}}}\RktVal{0{\hbox{\texttt{.}}}25}\RktPn{)}

\mbox{\hphantom{\Scribtexttt{xxxxxx}}}\RktPn{(}\RktSym{/}\mbox{\hphantom{\Scribtexttt{x}}}\RktVal{0{\hbox{\texttt{.}}}6}\mbox{\hphantom{\Scribtexttt{x}}}\RktVal{0{\hbox{\texttt{.}}}3}\RktPn{)}\RktPn{)}\RktPn{)}

\mbox{\hphantom{\Scribtexttt{x}}}

\RktPn{(}\RktSym{\mbox{{-}}}\mbox{\hphantom{\Scribtexttt{x}}}\RktPn{(}\RktSym{+}\mbox{\hphantom{\Scribtexttt{x}}}\RktVal{0{\hbox{\texttt{.}}}7}

\mbox{\hphantom{\Scribtexttt{xxxxxx}}}\RktPn{(}\RktSym{/}\mbox{\hphantom{\Scribtexttt{x}}}\RktVal{1/2}\mbox{\hphantom{\Scribtexttt{x}}}\RktVal{0{\hbox{\texttt{.}}}25}\RktPn{)}\RktPn{)}

\mbox{\hphantom{\Scribtexttt{xxx}}}\RktPn{(}\RktSym{/}\mbox{\hphantom{\Scribtexttt{x}}}\RktVal{0{\hbox{\texttt{.}}}6}\mbox{\hphantom{\Scribtexttt{x}}}\RktVal{0{\hbox{\texttt{.}}}3}\RktPn{)}\RktPn{)}

\mbox{\hphantom{\Scribtexttt{x}}}

\RktCmt{;}\RktCmt{~}\RktCmt{Arithmetik mit rationalen Zahlen (rational) ist exakt}

\RktPn{(}\RktSym{\mbox{{-}}}\mbox{\hphantom{\Scribtexttt{x}}}\RktPn{(}\RktSym{+}\mbox{\hphantom{\Scribtexttt{x}}}\RktVal{7/10}

\mbox{\hphantom{\Scribtexttt{xxxxxx}}}\RktPn{(}\RktSym{/}\mbox{\hphantom{\Scribtexttt{x}}}\RktVal{1/2}\mbox{\hphantom{\Scribtexttt{x}}}\RktVal{1/4}\RktPn{)}\RktPn{)}

\mbox{\hphantom{\Scribtexttt{xxx}}}\RktPn{(}\RktSym{/}\mbox{\hphantom{\Scribtexttt{x}}}\RktVal{3/5}\mbox{\hphantom{\Scribtexttt{x}}}\RktVal{3/10}\RktPn{)}\RktPn{)}\end{SingleColumn}\end{RktBlk}\end{SCodeFlow}
\end{mdframed}
